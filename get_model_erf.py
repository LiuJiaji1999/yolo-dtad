...
def get_params():
    params = {
        'weight': '/home/lenovo/data/liujiaji/yolov8/ultralytics-main/runs/train/exp80/weights/best.pt', # 只需要指定权重即可
        'device': 'cuda:0',
        'layer': '21', # string  如果换了主干，p3 0-2,p4 0-3,p5 0-4是一定有的
        'dataset': '/home/lenovo/data/liujiaji/yolov8/powerdata/images/train',# 训练集图片路径
        'num_images': 100, # 多少张计算感受野
        'save_path': '/home/lenovo/data/liujiaji/powerGit/yolov8/image/erf_tdadh-3.png'
    }
    return params
