...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/lenovo/data/liujiaji/yolov8/ultralytics-main-8.1.9/runs/train/exp119/weights/best.pt', help='trained weights path')
