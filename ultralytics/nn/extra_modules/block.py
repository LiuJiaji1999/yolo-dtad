...
__all__ = ['DyHeadBlock', 'DyHeadBlockWithDCNV3', 'Fusion', 'C2f_Faster', 'C3_Faster', 'C3_ODConv', 'C2f_ODConv', 'Partial_conv3', 'C2f_Faster_EMA', 'C3_Faster_EMA', 'C2f_DBB',
           ...
           'C3_Star', 'C2f_Star', 'C3_Star_CAA', 'C2f_Star_CAA','EIEStem', 'C3_EIEM', 'C2f_EIEM','ContextGuideFusionModule','C2f_Heat','SBA','CSP_PTB',
           'DomainClassify']
...
class Star_Block_CAA(Star_Block):
    def __init__(self, dim, mlp_ratio=3, drop_path=0):
        ...
        self.attention = CAA(mlp_ratio * dim) # 可更换其他注意力机制 PKInet中的CAA
...
################# DomainClassify begin #################

# from  ultralytics.utils.domain_grl  import GradientReversalLayer
from  ultralytics.utils.domain_grl  import GradientScalarLayer
