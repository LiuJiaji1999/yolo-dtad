...
__all__ = ['Detect_DTADH', 'Detect_DyHead', 'Detect_DyHeadWithDCNV3', 'Detect_DyHeadWithDCNV4', 'Detect_AFPN_P345', 'Detect_AFPN_P345_Custom', 'Detect_AFPN_P2345', 'Detect_AFPN_P2345_Custom', 'Detect_Efficient', 'DetectAux',
...
class Detect_DTADH(nn.Module):
    ...
    def __init__(self, nc=80, hidc=256, ch=()):
        ...
        self.cv2 = nn.Conv2d(hidc // 2, 4 * self.reg_max, 1) # conv_Reg
        self.cv3 = nn.Conv2d(hidc // 2, self.nc, 1) # conv_cls
