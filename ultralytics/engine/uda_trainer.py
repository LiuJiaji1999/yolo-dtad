...
class UDABaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        ...
        self.targetset = self.data["target"]
    ...
    def _setup_train(self, world_size):
        ...
        # # update
        # iterations_target = math.ceil(len(self.target_loader.dataset) / max(self.batch_size, self.args.nbs)) * self.epochs
