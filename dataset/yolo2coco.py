...
parser.add_argument('--image_path', default='/home/lenovo/data/liujiaji/yolov8/powerdata/images/test/',type=str, help="path of images")
parser.add_argument('--label_path', default='/home/lenovo/data/liujiaji/yolov8/powerdata/labels/test/',type=str, help="path of labels .txt")
parser.add_argument('--save_path', type=str,default='/home/lenovo/data/liujiaji/yolov8/powerdata/test.json', help="if not split the dataset, give a path to a json file")
